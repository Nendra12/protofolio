    ...
    return (
        <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8 min-h-screen border-t border-purple-500/20 py-20">
            ...
            <div className="flex flex-col lg:flex-row gap-8 lg:gap-12">
                ...
                {/* Info Section - Right (shows first on mobile, second on desktop) */}
                <div className="w-full lg:w-1/2 order-1 lg:order-2">
                    <div className="bg-white/5 backdrop-blur-sm border flex flex-col justify-center border-purple-500/20 rounded-2xl p-8 h-full">
                        {/* Profile and Quote */}
                        ...
                        <p className="text-gray-300 leading-relaxed mb-8">
                            My inbox is always open, whether you have questions or just want to say hello. I'd love to hear from you. Feel free to contact me, and I'll get back to you promptly.
                        </p>

                        {/* Social Media Icons */}
                        <div className="flex flex-wrap items-center gap-6 group">
                            <a
                                href="https://linkedin.com/in/nendra12"
                                target="_blank"
                                rel="noopener noreferrer"
                                className="flex items-center justify-center w-5 h-5 rounded-lg hover:brightness-110 hover:shadow-lg transition-all duration-300 hover:-translate-y-1 group-hover:opacity-40 hover:!opacity-100"
                                aria-label="LinkedIn"
                            >
                                <svg className=" text-white transition-colors duration-300" fill="currentColor" viewBox="0 0 24 24">
